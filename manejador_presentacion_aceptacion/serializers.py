...
class ClienteSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Cliente
        fields = ['id', 'nombre', 'apellido', 'direccion', 'ciudad', 'departamento', 'codigo_postal', 'pais', 'telefono', 'email', 'fecha_nacimiento', 'solicitudes', 'tarjetas', 'informacionfinanciera', 'documento']